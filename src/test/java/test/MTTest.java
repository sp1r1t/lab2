...
public class MTTest {
    ...
    public void test() throws Exception {
        ...
        // read config
        Config config = new Config("src/test/resources/loadtest.properties");
        String key = "mttest";
        try {
            key = "clients";
            clients = config.getInt(key);
            key = "uploadsPerMinute";
            uploadsPerMinute = config.getInt(key);
            key = "downloadsPerMinute";
            downloadsPerMinute = config.getInt(key);
            key = "fileSize";
            fileSize = config.getInt(key);
            key = "overwriteRatio";
            overwriteRatio = config.getInt(key);
        }
        ...
        System.out.println(overwriteRatio); 
